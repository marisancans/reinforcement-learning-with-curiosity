...
parser.add_argument('-epsilon_decay', default=1e-5, type=float, help='Epslion decay for exploration / explotation policy')
...
parser.add_argument('-rank_update', default=50, type=int, help='After how many steps is memory sorted(only for rank prioritization)')
...
# if not nothing autoencoder is MUST
